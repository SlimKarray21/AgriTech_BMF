...
import com.pistoncontrol.application.service.AdminService
import com.pistoncontrol.application.service.AuditLogService
import com.pistoncontrol.domain.model.UpdateUserRoleRequest
import com.pistoncontrol.domain.model.UsersListResponse
import io.ktor.http.*
 ...
 */
fun Route.adminRoutes(deviceService: com.pistoncontrol.application.service.DeviceService) {
        ...
        route("/api/admin") {
            ...
            get("/users") {
                try {
                    ...
                    call.respond(HttpStatusCode.OK, UsersListResponse(users = users, total = total))
                } catch (e: Exception) {
                    call.respond(
